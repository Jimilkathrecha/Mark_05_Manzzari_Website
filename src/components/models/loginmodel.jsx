    ...
    return (
        <>
            <div id="common-button">
                <button className="btn secondary-btn false custom-btn" id="loginButton" data-toggle="modal" data-target="#loginModal" /*data-url="/on/demandware.store/Sites-Tanishq-Site/en_IN/CustomerForm-Get"*/ fdprocessedid="7nqty">
                    <a href="#loginModal">
            ...
            <div className="modal login-pop-modal p-0 show" data-keyboard="true" data-backdrop="static" id="loginModal" tabindex="-1" /*style="display: block; padding-right: 17px;" aria-modal="true"*/>
                <div className="modal-dialog modal-dialog-centered loginmodalcenter registermodalcenter">
                    <div className="modal-content">
                        <div className="modal-body">
                            <button type="button" className="registerpopup-close loginpopup-close btn-close" data-bs-dismiss="modal" fdprocessedid="hq1k1k">
                                <img src="/on/demandware.static/Sites-Tanishq-Site/-/default/dw31377196/images/Group 14430.svg" alt="cross icon not load" width="34" height="34" className="mx-auto d-sm-none d-md-block" />
                                <img src="/on/demandware.static/Sites-Tanishq-Site/-/default/dw1149e82f/images/cross-smallscreen.svg" alt="cross icon not load" width="24" height="24" className="mx-auto d-sm-block d-md-none" />
                            </button>

                            <div className="container" id="login-popup" data-form-id="Log_n_sign_up" data-form-name="Log in Sign Up">
                                <div className="row row-img-right">
                                    ...
                                    <div className="col-md-8 col-sm-12 loginpopup-left">
                                        <div className="content-asset login-or-signup-title">
                                            ...
                                            <div className="welcome-500-image"><img className="img-fluid" alt="login-pop-up" src="https://www.tanishq.co.in/on/demandware.static/-/Library-Sites-TanishqSharedLibrary/default/dw68b03088/login-pop-up.jpg" title="" /></div>
                                        </div>
                                        <div className="loginpopup-formdiv">
                                            <form action="javascript:void(0);" id="login-form" className="login-form" method="POST" name="dwfrm_profile">
                                                <div className="mb-3 form-check">
                                                    <div className="input-group flex-nowrap">

                                                        <div className="country-selector-dropdown" id="popup-custom-drop">
                                                            <select id="countrycode" className="form-select phone-code d-none" name="dwfrm_profile_countryCode" required="" aria-required="true" value="" maxlength="2147483647" autocomplete="code">
                                                                <option id="+91" value="+91" data-iso-code="IN" data-phone-min-length="10.0" data-phone-max-length="10.0" selected="selected"> +91</option> 
                                                            ...
                                                            <div className="custom-drop-down-pop">
                                                                <span className="selected-value-pop">

                                                                    +91
                                                                </span>
                                                                <i id="arrowDown-pop" className="fa fa-angle-down down-arrow-pop pl-0" /*style="transform: rotate(0deg); transition: all 0.5s ease 0s;"*/></i>
                                                            </div>
                                                            <div className="option-values-pop option-values-second-pop custom-hide">
                                                                <ul className="m-0 p-0">
                                                                    <li id="+91" className="option-value-pop" value="+91" data-iso-code="IN" data-phone-min-length="10.0" data-phone-max-length="10.0">
                                                                        <img src="/on/demandware.static/-/Library-Sites-TanishqSharedLibrary/default/dw1075ce53/images/flags/in.svg" alt="" />
                                                                        <span>+91</span>
                                                                    </li>
                                                        ...
                                                        <div id="floating-label-group" className="phoneno-field">
                                                            <input type="text" placeholder=" " maxlength="10.0" minlength="10.0" className="form-control mobileinputfield" id="mobile" aria-describedby="addon-wrapping" name="dwfrm_profile_phone" required="" aria-required="true" value="" fdprocessedid="eubzx" />
                                                            <label className="floating-label mobileno-label">Enter your Mobile Number</label>
                                                            <span className="errormsg d-none" id="valid-error">Please enter valid Mobile Number</span>
                                                            <span className="errormsg d-none" id="default-error">Enter Mobile Number</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="csrf_token" value="ipQ5x7QqxkzaX0ZSOoHIEi4zofLdp2_INLV1ecM320A6PSUhP0Jio5ajFSjJ2GXCN7MoqJpL3sKeQJwQ6vS7dSZzSm_Uv1-MkWjsCXR4zz-YWYoxU8NZGfbMtC094pEvriDQb9kFcluQ5GQAgkMKw8c7IOADSaoXYngGU-J2274OF56ix1U=" />
                                                <div className="mb-3 form-check form-checkbox">
                                                    <input type="checkbox" className="form-check-input" id="exampleCheck1" name="dwfrm_profile_rememberMe" value="true" checked="" />
                                        ...
                                        <div className="loginpopup-terms text-center">
                                            <div className="content-asset login-agree-terms">
                                                <p className="terms-line text-center">By continuing, I agree to <a className="terms-link" href="https://www.tanishq.co.in/terms-and-conditions.html?lang=en_IN" target="_blank">Terms of Use</a> &amp; <a className="terms-link" href="https://www.tanishq.co.in/privacy-policy.html?lang=en_IN" target="_blank">Privacy Policy</a></p>
                                            </div>
                                        </div>
                                        <div className="text-center">
                                            <button className="loginpopup-submitbutton btn btn-primary btn-lg" data-requestotpurl="https://www.tanishq.co.in/on/demandware.store/Sites-Tanishq-Site/en_IN/OtpVerification-SendOTP" type="submit" fdprocessedid="3fg95e">Request OTP</button>
                                    ...
                                    <div className="col-md-8 col-sm-12 otppopup-left d-none">
                                        ...
                                        <div className="mobile-otp-block">
                                            ...
                                            <div className="otp-mobileno sent-otp">OTP Sent to mobile number
                                                <span className="pl-2 d-inline-block resent-otp-mobilenumber" id="entered-mobile-number"></span>
                                            </div>
                                            <div className="otp-mobileno resent-otp d-none">OTP Resent to mobile number
                                                <span className="pl-2 d-inline-block resent-otp-mobilenumber" id="entered-mobile-number"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="email-otp-block d-none">
                                            ...
                                            <div className="otp-mobileno">OTP Sent to email ID
                                                <span className="d-inline-block" id="entered-emailid"></span>
                                            </div>
                                        </div>
                                        <div className="enter-otp-pop">Enter OTP</div>
                                        <div className="otppopup-formdiv">
                                            <form action="javascript:void(0);" id="otp-form" className="otp-form" method="POST" name="dwfrm_profile">
                                                <input type="hidden" name="csrf_token" value="giBc6qsxnUBGa9epwGtz49f731OHwNZK5EMZ3HxgIvg-f8rRJTJlMYLkFmlyXFvnfKwIJlCq6x-vsKGAH7Tx5ruXQlXaJG6OgQaJnhZ82VWcMRcUcHwa0iimc6zKx4G63CTEEiZXFnejROHXnDi2kDPd5Q4pm64HS9tgok_J9mfzSJmtkyM=" />
                                                <div className="otpfeilds">
                                                    <div className="otp-boxes-otp d-flex align-item-center justify-content-center">
                                                        <input type="tel" className="form-control-otp otp-input" autocomplete="off" placeholder="-" name="dwfrm_profile_otp1" required="" aria-required="true" value="" maxlength="1" minlength="1" />
                                                        <input type="tel" className="form-control-otp otp-input" autocomplete="off" placeholder="-" name="dwfrm_profile_otp2" required="" aria-required="true" value="" maxlength="1" minlength="1" />
                                                        <input type="tel" className="form-control-otp otp-input" autocomplete="off" placeholder="-" name="dwfrm_profile_otp3" required="" aria-required="true" value="" maxlength="1" minlength="1" />
                                                        <input type="tel" className="form-control-otp otp-input" autocomplete="off" placeholder="-" name="dwfrm_profile_otp4" required="" aria-required="true" value="" maxlength="1" minlength="1" />
                                                        <input type="tel" className="form-control-otp otp-input" autocomplete="off" placeholder="-" name="dwfrm_profile_otp5" required="" aria-required="true" value="" maxlength="1" minlength="1" />
                                                        <input type="tel" className="form-control-otp otp-input" autocomplete="off" placeholder="-" name="dwfrm_profile_otp6" required="" aria-required="true" value="" maxlength="1" minlength="1" />
                                                    </div>
                                                </div>
                                                <p id="otp-error"></p>
                                                ...
                                                <div className="otp-below-text-question mt-3 mt-md-5">
                                                    <div className="otp-question text-center my-3">
                                                        ...
                                                        <button type="button" className="resend resend-link" id="resendLink" data-resendotpurl="https://www.tanishq.co.in/on/demandware.store/Sites-Tanishq-Site/en_IN/OtpVerification-ResendOTP" disabled=""/*style="border: none;"*/>Resend</button>
                                        ...
                                        <div className="text-center">
                                            <button className="otppopup-submitbutton btn btn-primary btn-lg" type="submit" data-verifyotpurl="https://www.tanishq.co.in/on/demandware.store/Sites-Tanishq-Site/en_IN/OtpVerification-VerifyOTP" data-verifyemailotpurl="https://www.tanishq.co.in/on/demandware.store/Sites-Tanishq-Site/en_IN/OtpVerification-VerifyEmailOTP">
                                                Verify OTP
                                            </button>
                                        </div>
                                    </div>
                                    <div className="col-md-4 col-sm-12 loginpopup-right">
                                        <div className="content-asset login-popout-image">
                                            <img src="https://www.tanishq.co.in/on/demandware.static/-/Library-Sites-TanishqSharedLibrary/default/dwcaaa047f/login_signup/Mask-Group.png" alt="image not found" width="100%" height="100%" className="d-lg-block d-md-block d-none" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row row-img-right">
                                    ...
                                    <div className="col-md-8 col-sm-12 registerpopup-left">
                                        ...
                                        <span className="registerpopup-header">
                                            <div className="content-asset register-user-title">
                                                ...
                                                <div className="register-subheading mb-3">Welcome! Please fill the details</div>
                                            </div>
                                        </span>

                                        <span className="existing-customerpopup-header">
                                            <div className="content-asset register-almost-there-welcome">
                                                <h4 className="existing-customerpopup-heading">Almost there!</h4>
                                                <div className="existing-customerpopup-subheading">Welcome back, Please fill the missing fields.</div>
                                            </div>
                                            <input type="hidden" className="welcome-back-input" value="Welcome back," />
                                            <input type="hidden" className="fill-input-feild" value="! Please fill the missing fields." />
                                        </span>

                                        <div className="registerpopup-formdiv">
                                            <form action="javascript:void(0);" id="register-form" className="register-form" method="POST" name="dwfrm_profile">
                                                <input type="hidden" name="csrf_token" value="7BQgTQspRLS7k3apsDhJQjyTy9DYw-bbexnbWxSYaS_tedRGfNlMXpSecArRDposbgFuR6V-zcmmLMd4BhyuCKXbI7SRQ4-BLGmvjL7XPJoweCVtAaKXGpp98OSArI0ZV4sVF-xcMw4yWvSyiqU8nfpdcUMHP7BnmoKe9R9PHs8VQKscXR8=" />
                                                <div className="row">
                                                    <div className="col-12 selectdiv-register">
                                                        <div id="floating-label-group">
                                                            <div className="country-selector-dropdown" id="salutation-custom-drop">
                                                                <select id="salutation" className="form-control drop d-none" name="dwfrm_profile_salutation" required="" aria-required="true" autocomplete="code">
                                                                    <option disabled="disabled" selected="true" value="">Select
                                                                    </option>
                                                                    <option id="mr" value="Mr">Mr</option>
                                                                    <option id="ms" value="Ms">Ms</option>
                                                                </select>
                                                                <div className="custom-drop-down-salutation">
                                                                    <span className="selected-value-salutation">Title</span>
                                                                    <i id="arrowDown-salutation" className="fa fa-angle-down down-arrow-salutation pl-0"></i>
                                                                </div>
                                                                <div className="option-values-salutation option-values-second-salutation custom-hide">
                                                                    <ul className="m-0 p-0">
                                                                        <li id="mr" className="option-value-salutation" value="Mr">
                                                                            <span>Mr</span>
                                                                        </li>
                                                                        <li id="ms" className="option-value-salutation" value="Ms">
                                                                            <span>Ms</span>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            <div className="text-danger" id="blank-salutation"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="row mt-4">
                                                    <div className="col-12">
                                                        <div id="floating-label-group">
                                                            <input id="full-name" type="text" className="form-control" placeholder=" " autocomplete="off" autofocus="" required="" name="dwfrm_profile_fullname" aria-required="true" value="" maxlength="100" />
                                                            <label className="floating-label">Enter Full Name</label>
                                                            <div className="text-danger" id="blank-fname"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="row mt-4 ">
                                                    <div className="col-4">
                                                        <div id="floating-label-group" className="arrow-down-reg">
                                                            <input id="country-code" type="text" placeholder=" " className="form-control" autocomplete="off" autofocus="" required="" name="dwfrm_profile_countryCode" aria-required="true" value="" maxlength="2147483647" />
                                                    ...
                                                    <div className="col-8">
                                                        <div id="floating-label-group">
                                                            <input id="phone-number" type="text" placeholder=" " className="form-control mobileinputfield-form" autocomplete="off" autofocus="" required="" name="dwfrm_profile_phone" aria-required="true" value="" maxlength="2147483647" />
                                                ...
                                                <div className="row mt-4">
                                                    <div className="col-12">
                                                        <div id="floating-label-group">
                                                            <input id="email" type="text" placeholder=" " className="form-control email" autocomplete="off" autofocus="" required="" name="dwfrm_profile_email" aria-required="true" value="" maxlength="50" pattern="^[\w.%+-]+@[\w.-]+\.[\w]{2,6}$" />
                                                            <label className="floating-label">Enter Email ID</label>
                                                            <div className="text-danger" id="blank-email"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                        ...
                                        <div className="text-center">
                                            <button className="registerpopup-submitbutton btn btn-primary btn-lg" type="submit" data-oauthreentryurl="https://www.tanishq.co.in/on/demandware.store/Sites-Tanishq-Site/en_IN/Login-OAuthReentry">
                                                Continue
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-8 col-sm-12 already-registeremail-left d-none">
                                        <div className="heading-section">
                                            <div className="content-asset email-already-registered-below-phone-number">
                                                <h4 className="main-heading">Email ID is already registered with us !</h4>
                                                <div className="sub-heading">This email is registered against the below phone number. Verify the email to swap it to the account you are creating.</div>
                                            </div>
                                            <div className="or py-1">OR</div>
                                            <div className="sub-heading pb-2">Continue with registered mobile number</div>
                                        </div>
                                        <div className="row mb-5 mt-3 radio-block">
                                            <div className="col-12 col-sm-5 mb-2 mb-sm-0">
                                                <div className="form-check email-already p-sm-0 flex">
                                                    <input className="form-check-input phone-radio-button" type="radio" name="flexRadioDefault" id="phoneRadioButton" />
                                                    <label id="phoneRadioText" className="form-check-label pl-3 phone-radio-text" for="flexRadioDefault1"></label>
                                                </div>
                                            </div>
                                            <div className="col-12 col-sm-7">
                                                <div className="form-check email-already p-sm-0 flex">
                                                    <input className="form-check-input email-radio-button" type="radio" name="flexRadioDefault" id="emailRadioButton" />
                                                    <label id="emailRadioText" className="form-check-label pl-3 email-radio-text" for="flexRadioDefault1"></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="registerpopup-terms text-center">
                                        ...
                                        <div className="text-center">
                                            <button className="emailid-already-submitbutton btn btn-primary btn-lg" type="submit" data-emailswappableurl="https://www.tanishq.co.in/on/demandware.store/Sites-Tanishq-Site/en_IN/OtpVerification-EmailSwappable">
                                                Continue
                                            </button>
                                        </div>
                                    </div>
                                    <div className="col-md-4 col-sm-12 registerpopup-right medium-screen-image">
                                        <div className="content-asset login-popout-image-on-form">
                                            <img src="https://www.tanishq.co.in/on/demandware.static/-/Library-Sites-TanishqSharedLibrary/default/dwe9639bfc/login_signup/Group-14443.png" alt="Girl in a jacket" /*style="width:100%;height:100%;"*/ />
                                        </div>
                                    </div>
