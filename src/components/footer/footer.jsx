          ...
          <div className="d-flex flex-wrap justify-content-between">
            <div className="text-center">
              ...
              <form noValidate="noValidate" className="">
                    ...
                    <div className="v-input__slot">
                      <div className="v-text-">
                        <input
                          ...
                          type="email"
                          className="px-3 rounded w-100 p-2"
                        />
                      </div>
                    </div>
                  </div>
                ...
                <button
                  type="submit"
                  className="v-btn my-3 px-3 border border-brown rounded tx-brown"
                >
              ...
              <ul className="ps-0 fs-13">
                <li className="py-2">
                  <span>
                    <a
                      href="#"
                      className="tx-white text-decoration-none"
                      aria-current="page"
                    >
                      Home
                    </a>
                ...
                <li className="py-2">
                  <span>
                    <a href="#" className="tx-white text-decoration-none">
                      All Categories
                    </a>
                  </span>
                </li>
            ...
            <div className="mb-5">
              <h4 className="tx-brown mb-4 fs-5">My Account</h4>
              <ul className="ps-0 fs-13">
                <li className="py-2">
                  <span>
                    <a href="#" className="tx-white text-decoration-none">
            ...
            <div className="mb-5">
              ...
              <ul className="ps-0 fs-13">
                ...
                <li className="py-2 mb-2">
                  ...
                  <div>support@activesupershop.com</div>
                </li>
                <li className="py-2 mb-2">
                  <div className="icon-color text-gray-400 opacity-50">
            ...
            <div className="col-md-6 col-12">
              <div className="lh-1 fs-13">
                ...
                <p className="text-gray-400 mt-3">
                  © Grafizen International 2023 | Trademarks and brands are the
              ...
              <ul className="d-flex justify-content-end mt-2 ps-0">
                <li className="social-icon fs-6">
                  <a
                    href="#"
                    target="_blank"
                    className="hover:bg-blue-900 p-2 rounded-circle text-decoration-none border-1 border-brown transition-colors"
                  >
                ...
                <li className="social-icon ms-2 fs-6">
                  <a
                    href="#"
                    target="_blank"
                    className="hover:bg-blue-500 p-2 rounded-circle text-decoration-none border-1 border-brown transition-colors"
                  >
                ...
                <li className="social-icon ms-2 fs-6">
                  <a
                    href="#"
                    target="_blank"
                    className="hover:bg-gradient-to-tr from-purple-500 to-pink-500 p-2 rounded-circle text-decoration-none border-1 border-brown transition-colors"
                  >
                ...
                <li className="social-icon ms-2 fs-6">
                  <a
                    href="#"
                    target="_blank"
                    className="hover:bg-red-600 p-2 rounded-circle text-decoration-none border-1 border-brown transition-colors"
                  >
                ...
                <li className="social-icon ms-2 fs-6">
                  <a
                    href="#"
                    target="_blank"
                    className="hover:bg-cyan-800 p-2 rounded-circle text-decoration-none border-1 border-brown transition-colors"
                  >
