...
const product = [
  {
    id: 1,
    name: "Dainty Gold Fancy Diamond Stud Earrings",
    img: "https://www.tanishq.co.in/dw/image/v2/BKCK_PRD/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw9babb3bd/images/hi-res/501718SEQAAA09_1.jpg?sw=360&sh=360",
  },
  {
    id: 2,
    name: "Graceful Crossover Diamond Ring",
  ...
  {
    id: 3,
    name: "Sparkling Flower Diamond Stud Earrings",
    img: "https://www.tanishq.co.in/dw/image/v2/BKCK_PRD/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwb58ab686/images/hi-res/502998SCHAAA09_1.jpg?sw=360&sh=360",
  },
  {
    id: 4,
    name: "Leafy Charm Diamond Mangalsutra",
    img: "https://www.tanishq.co.in/dw/image/v2/BKCK_PRD/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwb842fe47/images/hi-res/505002SAVAGA09_1.jpg?sw=360&sh=360",
  },
  {
    id: 5,
    name: "Star Petite Layered Diamond Ring",
    img: "https://www.tanishq.co.in/dw/image/v2/BKCK_PRD/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw73a1156b/images/hi-res/505001SDGAGB02_1.jpg?sw=360&sh=360",
  },
  {
    id: 6,
    name: "Graceful Diamond Hoop",
    img: "https://www.tanishq.co.in/dw/image/v2/BKCK_PRD/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwb842fe47/images/hi-res/505002SAVAGA09_1.jpg?sw=360&sh=360",
  },
  {
    id: 7,
    name: "Extravagant Diamond Pendant and Earrings",
    img: "https://www.tanishq.co.in/dw/image/v2/BKCK_PRD/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw73a1156b/images/hi-res/505001SDGAGB02_1.jpg?sw=360&sh=360",
  },
  {
    id: 8,
    name: "Petite Round Diamond Stud Earrings",
    img: "https://www.tanishq.co.in/dw/image/v2/BKCK_PRD/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw9babb3bd/images/hi-res/501718SEQAAA09_1.jpg?sw=360&sh=360",
  },
  {
    id: 9,
...
export default function Kadli() {
  return (
    <>
                    ...
                    <div className="d-flex gap-4 w-100 justify-center">
                      <div className="w-[250px] hover:shadow-lg border-1 border-marun rounded-1 overflow-hidden">
                        <div className="w-fit relative">
                          ...
                          <Link to="/compare">
                            <i
                              className="fa fa-arrow-right-arrow-left absolute top-0 p-2 m-1 hov-scale-2 tx-marun"
                        ...
                        <div className="flex gap-2 w-100 p-[10px] pt-0">
                          <Link className="col" to="/product">
                            <div className="col text-center pointer my-2 rounded-1 border-1 border-marun">
                              <p className="px-3 py-[5px] fs-7 font-semibold">
                                Explore Now
                              </p>
                            </div>
                          </Link>
      ...
      <div>
        <Slider
          className="w-[90%] mx-auto 3xs:h-[200px] xs:h-[250px] lg:h-[300px] rounded-[15px] overflow-hidden pointer"
          {...faded}
        >
          <div className="w-100 rounded-[15px] overflow-hidden grab grabbing px-2">
            <img
              className="w-100 3xs:h-[200px] xs:h-[250px] lg:h-[300px] object-cover rounded-[15px] pointer-events-none"
              src="./images/styleof life-images/banner4.1.png"
              alt=""
            />
          </div>
          <div className="w-100 rounded-[15px] overflow-hidden grab grabbing px-2">
            <img
              className="w-100 3xs:h-[200px] xs:h-[250px] lg:h-[300px] object-cover rounded-[15px] pointer-events-none"
              src="images/banner-animation/styleoflife-2.png"
              alt=""
            />
          </div>
          <div className="w-100 rounded-[15px] overflow-hidden grab grabbing px-2">
            <img
              className="w-100 3xs:h-[200px] xs:h-[250px] lg:h-[300px] object-cover rounded-[15px] pointer-events-none"
              src="images/banner-animation/styleoflife-3.png"
              alt=""
            />
          </div>
          <div className="w-100 rounded-[15px] overflow-hidden grab grabbing px-2">
