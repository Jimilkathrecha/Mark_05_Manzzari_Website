...
// Compare
export const ADD_COMPAER = "ADD_COMPAER";
export const UPDATE_COMPAER = "UPDATE_COMPAER";
export const DELETE_COMPAER = "DELETE_COMPAER";
export const GET_ALL_COMPAER = "GET_ALL_COMPAER";
// Collection
export const ADD_COLLECTION = "ADD_COLLECTION";
export const UPDATE_COLLECTION = "UPDATE_COLLECTION";
export const DELETE_COLLECTION = "DELETE_COLLECTION";
export const GET_ALL_COLLECTION = "GET_ALL_COLLECTION";
export const GET_ALL_COLLECTION_NAME_LIST = "GET_ALL_COLLECTION_NAME_LIST";
export const GET_ONE_COLLECTION = "GET_ONE_COLLECTION";
export const REMOVE_ITEM_COLLECTION = "REMOVE_ITEM_COLLECTION";
